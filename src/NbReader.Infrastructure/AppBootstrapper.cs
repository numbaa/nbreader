...
public static class AppBootstrapper
{
    public static AppRuntime Initialize()
    {
        ...
        return new AppRuntime(settings, settingsStore, database, logger, seriesQueryService, seriesSearchService, libraryMaintenanceService, volumeQueryService, readingProgressService);
    }
}